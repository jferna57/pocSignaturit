...
public class ContractResourceIntTest {
    ...
    private static final ZonedDateTime DEFAULT_SENT_TO_BE_SIGNED_DATE = ZonedDateTime.ofInstant(Instant.ofEpochMilli(0L), ZoneId.systemDefault());
    private static final ZonedDateTime UPDATED_SENT_TO_BE_SIGNED_DATE = ZonedDateTime.now(ZoneId.systemDefault()).withNano(0);
    private static final String DEFAULT_SENT_TO_BE_SIGNED_DATE_STR = dateTimeFormatter.format(DEFAULT_SENT_TO_BE_SIGNED_DATE);
    ...
    public static Contract createEntity(EntityManager em) {
        Contract contract = new Contract()
                ...
                .sentToBeSignedDate(DEFAULT_SENT_TO_BE_SIGNED_DATE)
    ...
    public void createContract() throws Exception {
        ...
        assertThat(testContract.getSentToBeSignedDate()).isEqualTo(DEFAULT_SENT_TO_BE_SIGNED_DATE);
    ...
    public void getAllContracts() throws Exception {
        ...
        restContractMockMvc.perform(get("/api/contracts?sort=id,desc"))
                ...
                .andExpect(jsonPath("$.[*].sentToBeSignedDate").value(hasItem(DEFAULT_SENT_TO_BE_SIGNED_DATE_STR)))
    ...
    public void getContract() throws Exception {
        ...
        restContractMockMvc.perform(get("/api/contracts/{id}", contract.getId()))
            ...
            .andExpect(jsonPath("$.sentToBeSignedDate").value(DEFAULT_SENT_TO_BE_SIGNED_DATE_STR))
    ...
    public void updateContract() throws Exception {
        ...
        updatedContract
                ...
                .sentToBeSignedDate(UPDATED_SENT_TO_BE_SIGNED_DATE)
        ...
        assertThat(testContract.getSentToBeSignedDate()).isEqualTo(UPDATED_SENT_TO_BE_SIGNED_DATE);
