...
import net.juancarlosfernandez.jhipster.config.audit.AuditEventConverter;
import net.juancarlosfernandez.jhipster.domain.PersistentAuditEvent;
import net.juancarlosfernandez.jhipster.repository.PersistenceAuditEventRepository;
import net.juancarlosfernandez.jhipster.service.AuditEventService;
