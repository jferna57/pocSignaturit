(function() {
    ...
    ContractDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'DataUtils', 'entity', 'Contract', 'Signer', 'Creator'];

    function ContractDialogController ($timeout, $scope, $stateParams, $uibModalInstance, DataUtils, entity, Contract, Signer, Creator) {
        var vm = this;
        ...
        vm.datePickerOpenStatus.sentToBeSignedDate = false;
